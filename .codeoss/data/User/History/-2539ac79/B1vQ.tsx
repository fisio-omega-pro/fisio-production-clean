...
const styles = {
  ...
  faqAsymmetricGrid: { display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '100px', maxWidth: '1400px', margin: '0 auto', alignItems: 'start' } as React.CSSProperties,
  faqTextSide: { textAlign: 'left', position: 'relative' } as React.CSSProperties,
  faqVisualSide: { display: 'flex', justifyContent: 'center', width: '100%' } as React.CSSProperties,
  ...
  copyrightText: { textAlign: 'center', fontSize: '12px', opacity: 0.2, fontWeight: 800, letterSpacing: '4px', borderTop: '1px solid rgba(255,255,255,0.03)', paddingTop: '50px' } as React.CSSProperties,
