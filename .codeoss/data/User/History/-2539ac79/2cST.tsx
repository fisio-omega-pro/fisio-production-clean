...
const styles = {
  ...
  // --- Estilos para las mejoras solicitadas ---
...
// ==========================================
// 🧩 SUB-COMPONENTES (RESPECTING NAMES)
// ==========================================
...
export default function Page() {
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      {/* --- HERO (VIDEO REMOVIDO DE AQUÍ PARA EVITAR BLUR) --- */}
      ...
      {/* --- BLOQUE VIDEO (POSICIÓN FIJA, FUERA DE HERO) --- */}
      ...
      {/* --- FOOTER (ENLACES LEGALES ACTUALIZADOS) --- */}
      <footer style={styles.footer}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '80px', maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div>
             ...
             <a href="#" style={{ display: 'block', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '10px', fontSize: '14px' }}>Devolución</a>
             <a href="#" style={{ display: 'block', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '10px', fontSize: '14px' }}>Garantía</a>
             <a href="#" style={{ display: 'block', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '10px', fontSize: '14px' }}>Formas de Pago</a>
          </div>
          <div>
             <p style={{ fontSize: '12px', fontWeight: 900, color: '#0066ff', letterSpacing: '3px', marginBottom: '20px' }}>LEGAL</p>
             <a href="#" style={{ display: 'block', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '10px', fontSize: '14px' }}>Condiciones</a>
             <a href="#" style={{ display: 'block', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '10px', fontSize: '14px' }}>Política de privacidad</a>
             <a href="#" style={{ display: 'block', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '10px', fontSize: '14px' }}>Política de cookies</a>
          </div>
          <div>
