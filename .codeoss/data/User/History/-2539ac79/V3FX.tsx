...
export default function Page() {
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      {/* --- HERO SECTION: SOLO EL TEXTO SE DESVANECE --- */}
      <motion.header style={{ ...styles.heroSection, opacity: opacityHero, scale: scaleHero }}>
        ...
        <p style={styles.heroDescription}>Ana es la Inteligencia Conductual que blinda tu agenda, <br />elimina tus No-Shows y recupera tu tiempo de vida.</p>
        <button onClick={() => window.location.href='/setup'} style={styles.btnMain}>EMPEZAR MI REVOLUCIÓN GRATIS ➜</button>
      </motion.header>

      {/* --- BLOQUE DE VÍDEO INDEPENDIENTE (NO DESAPARECE) --- */}
      <div style={{ marginTop: '-50px', position: 'relative', zIndex: 10, textAlign: 'center' }}>
      ...
      <section id="licencia" style={styles.sectionPadding}>
        <div style={styles.asymmetricGrid}>
          ...
          <motion.div whileHover={{ scale: 1.02 }} style={styles.activationCard}>
             ...
             <button onClick={() => window.location.href='/setup'} style={styles.btnActivate}>ACTIVAR MI ASISTENTE ➜</button>
          </motion.div>
        </div>
      </section>
