...
const styles = {
  ...
  priceTag: { fontSize: '80px', fontWeight: 900, color: '#0066ff' } as React.CSSProperties, // 100€ en Azul
  ...
  btnActivate: { background: '#0066ff', color: '#fff', border: 'none', padding: '20px 40px', borderRadius: '16px', fontWeight: 900, fontSize: '16px', cursor: 'pointer', width: '100%', marginTop: '30px', boxShadow: '0 10px 30px rgba(0,102,255,0.3)' } as React.CSSProperties, // Botón Azul
    ...
    <div style={styles.pageContainer}>
      ...
      <section style={styles.sectionPadding}>
        <div style={styles.faqAsymmetricGrid}>
          <div style={styles.faqTextSide}>
             ...
             <FaqCard q="¿Cómo funcionan las Banderas Rojas?" a="Ana realiza un triaje clínico. Casos de tráfico, suelo pélvico o bebés bloquean la cita automática y derivan a tu teléfono." />
             <FaqCard q="¿Cómo recibo mis ingresos?" a="Soberanía total: Stripe para automatización, Bizum o Efectivo. Tú eliges cómo y cuándo cobrar." />
             <FaqCard q="¿Qué es el historial por voz?" a="Ahorro de 1h/día. Dictas la evolución al terminar y Ana la transcribe y guarda en la ficha médica al instante." />
             <FaqCard q="¿Soporta varias clínicas?" a="Sistema multi-sede nativo. Gestiona todos tus centros desde un solo panel profesional." />
          </div>
          <div style={styles.faqVisualSide}>
             <div style={styles.technicalBox}>
                ...
                <div style={{marginTop:'40px', display:'flex', gap:'15px'}}>
                   <div style={{width:'40px', height:'4px', background:'#0066ff', borderRadius:'2px'}} />
                   <div style={{width:'20px', height:'4px', background:'rgba(255,255,255,0.1)', borderRadius:'2px'}} />
                </div>
             </div>
          </div>
        </div>
        ...
        <div style={styles.faqAsymmetricGrid}>
          <div style={styles.faqVisualSide}>
             <div style={styles.technicalBox}>
                ...
                <div style={{marginTop:'40px', display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:'10px'}}>
                   {[...Array(6)].map((_,i)=><div key={i} style={{width:'10px', height:'10px', background:i<3?'#10b981':'rgba(255,255,255,0.1)', borderRadius:'2px'}}/>)}
                </div>
             </div>
          </div>
          <div style={styles.faqTextSide}>
             ...
             <FaqCard q="¿Puedo importar mis pacientes?" a="Motor CSV incluido. Ana reconocerá a tus pacientes habituales por su nombre desde el primer saludo." />
             <FaqCard q="¿Ana reactiva antiguos pacientes?" a="Comercial incansable. Ana detecta la inactividad y lanza campañas de WhatsApp para recuperar tus ingresos." />
             <FaqCard q="¿Tengo canal de sugerencias?" a="Buzón de Innovación Pro. Tus ideas alimentan la evolución de la herramienta para ser siempre líder." />
          </div>
        </div>
      </section>
      ...
      <footer style={styles.footer}>
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '80px', maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div>
             <p style={{fontSize:'12px', fontWeight:900, color:'#0066ff', letterSpacing:'3px', marginBottom:'20px'}}>SOPORTE</p>
