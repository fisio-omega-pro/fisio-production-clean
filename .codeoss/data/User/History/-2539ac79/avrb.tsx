...
// ==========================================
// 🚀 PÁGINA PRINCIPAL (DEFAULT EXPORT)
// ==========================================
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <motion.header style={{ ...styles.heroSection, opacity: opacityHero }}>
        ...
        <button style={styles.btnGhost} onClick={() => window.scrollTo({top: 5000, behavior: 'smooth'})}>VER MÁS TESTIMONIOS</button>
      </motion.header>
      ...
      <section style={styles.sectionPadding}>
        <div style={styles.faqAsymmetricGrid}>
          <div style={styles.faqTextSide}>
             ...
             <FaqCard q="¿Qué es el historial por voz?" a="Ahorro de 1h/día. Dictas la evolución al terminar y Ana la guarda en la ficha médica al instante." />
          </div>
      ...
      <section style={{...styles.sectionPadding, background:'rgba(255,255,255,0.01)'}}>
        <div style={styles.faqAsymmetricGrid}>
          ...
          <div style={styles.faqTextSide}>
             ...
             <FaqCard q="¿Ana reactiva antiguos pacientes?" a="Comercial incansable. Ana detecta la inactividad y lanza campañas de WhatsApp para recuperar ingresos." />
             <FaqCard q="¿Soporta varias clínicas?" a="Sistema multi-sede nativo. Gestiona todos tus centros y equipos desde un solo panel centralizado." />
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '150px 20px', textAlign: 'center' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '100px 50px', background: 'linear-gradient(180deg, rgba(255,255,255,0.03) 0%, rgba(0,102,255,0.02) 100%)', borderRadius: '80px', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <button onClick={() => window.location.href='/setup'} style={{ ...styles.btnMain, padding: '25px 80px', fontSize: '22px' }}>ACTIVAR MI MES GRATUITO ➜</button>
        </div>
      </section>
      ...
      <footer style={styles.footer}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '80px', maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
             <p style={{fontSize:'12px', fontWeight:900, color:'#0066ff', letterSpacing:'3px', marginBottom:'10px'}}>SERVICIOS</p>
             <Link href="/devolucion" style={{color:'rgba(255,255,255,0.4)', textDecoration:'none', fontSize:'14px'}}>Devolución</Link>
             <Link href="/garantia" style={{color:'rgba(255,255,255,0.4)', textDecoration:'none', fontSize:'14px'}}>Garantía</Link>
             <Link href="/pagos" style={{color:'rgba(255,255,255,0.4)', textDecoration:'none', fontSize:'14px'}}>Formas de Pago</Link>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
             ...
             <Link href="/privacidad" style={{color:'rgba(255,255,255,0.4)', textDecoration:'none', fontSize:'14px'}}>Política de privacidad</Link>
             <Link href="/cookies" style={{color:'rgba(255,255,255,0.4)', textDecoration:'none', fontSize:'14px'}}>Política de cookies</Link>
          </div>
          <div>
             <p style={{fontSize:'12px', fontWeight:900, color:'#0066ff', letterSpacing:'3px', marginBottom:'10px'}}>CONTACTO</p>
