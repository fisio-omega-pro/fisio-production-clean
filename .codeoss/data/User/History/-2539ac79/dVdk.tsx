...
// --- INSTRUCCIÓN DE ARQUITECTURA PARA EVITAR EL BUILD ERROR ---
...
const styles = {
  ...
  loginBtn: { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(0,102,255,0.3)', color: '#fff', padding: '10px 25px', borderRadius: '100px', fontSize: '11px', fontWeight: 800, cursor: 'pointer' } as React.CSSProperties,
  ...
  pricingSideTitle: { fontSize: '48px', fontWeight: 900, lineHeight: '1.1', marginBottom: '30px', letterSpacing: '-3px' } as React.CSSProperties,
  ...
  // CORRECCIÓN: Se añade el estilo faltante que causaba error visual en los planes
  priceValue: { fontSize: '48px', fontWeight: 900, color: '#fff', marginBottom: '10px', display: 'flex', alignItems: 'baseline', justifyContent: 'center' } as React.CSSProperties,
 ...
 footer: { padding: '120px 8% 60px', background: '#010204', borderTop: '1px solid rgba(255,255,255,0.05)', position: 'relative' } as React.CSSProperties,
  footerGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '60px', maxWidth: '1400px', margin: '0 auto' } as React.CSSProperties,
  footerLinksGroup: { display: 'flex', flexDirection: 'column', gap: '15px' } as React.CSSProperties,
  footerTitle: { fontSize: '12px', fontWeight: 900, color: '#0066ff', letterSpacing: '2px', marginBottom: '20px', textTransform: 'uppercase' } as React.CSSProperties,
  fLink: { color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontSize: '14px', transition: '0.3s' } as React.CSSProperties,
  copyrightText: { fontSize: '11px', opacity: 0.2, fontWeight: 800, letterSpacing: '5px', textTransform: 'uppercase' } as React.CSSProperties,
  ...
  pricingGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto', alignItems: 'center' } as React.CSSProperties,
  priceCard: { background: 'rgba(255,255,255,0.015)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '32px', padding: '40px', textAlign: 'center', transition: '0.3s' } as React.CSSProperties,
  priceCardFeatured: { background: 'rgba(255,255,255,0.03)', border: '2px solid #0066ff', borderRadius: '32px', padding: '50px 40px', textAlign: 'center', position: 'relative', boxShadow: '0 20px 50px rgba(0,102,255,0.1)' } as React.CSSProperties,
  featuredBadge: { position: 'absolute', top: '-15px', left: '50%', transform: 'translateX(-50%)', background: '#0066ff', color: '#fff', padding: '5px 15px', borderRadius: '100px', fontSize: '10px', fontWeight: 900, letterSpacing: '1px' } as React.CSSProperties,
  planName: { fontSize: '18px', fontWeight: 800, marginBottom: '15px', color: '#fff' } as React.CSSProperties,
  planDesc: { fontSize: '13px', opacity: 0.4, marginBottom: '30px' } as React.CSSProperties,
  priceMonth: { fontSize: '16px', opacity: 0.3, marginLeft: '5px' } as React.CSSProperties,
  virtueListMini: { textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '40px' } as React.CSSProperties,
  btnActivateSec: { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', padding: '15px 30px', borderRadius: '100px', fontSize: '12px', fontWeight: 800, cursor: 'pointer', width: '100%' } as React.CSSProperties,
};
...
function FaqBlock({ q, a }: { q: string, a: string }) {
  return (
    <div style={{ background: 'rgba(255,255,255,0.015)', padding: '30px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)', marginBottom: '20px' }}>
      <h5 style={{ fontSize: '18px', fontWeight: 800, marginBottom: '15px', color: '#fff' }}>{q}</h5>
...
export default function Page() {
  ...
  // Ajuste de opacidad: Solo para el texto inicial, para que el vídeo no se pierda
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <header style={styles.heroSection}>
        {/* CORRECCIÓN: Envolvemos solo el texto en el motion.div para que el vídeo no se difumine al hacer scroll */}
        ...
        {/* El vídeo ahora permanece visible y sólido hasta que el scroll natural lo desplace */}
        <div id="experiencia" style={styles.videoBox}>
           ...
           <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=2070" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.4 }} alt="Clínica" />
        </div>
        <button style={{ ...styles.btnGhost, marginTop: '40px' }} onClick={() => window.scrollTo({top: document.body.scrollHeight, behavior: 'smooth'})}>VER MÁS TESTIMONIOS</button>
      </header>

      {/* --- SEGURIDAD MÉDICA --- */}
      <section style={{ padding: '100px 20px', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: '30px', background: 'rgba(255,255,255,0.02)', padding: '30px 60px', borderRadius: '100px', border: '1px solid rgba(255,255,255,0.05)' }}>
           <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', fontWeight: 700, opacity: 0.6 }}><ShieldCheck color="#0066ff" size={20}/> CIFRADO AES-256</div>
           <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', fontWeight: 700, opacity: 0.6 }}><Lock color="#0066ff" size={20}/> DPA SALUD UE</div>
           <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', fontWeight: 700, opacity: 0.6 }}><Server color="#0066ff" size={20}/> REGIÓN BÉLGICA</div>
        </div>
      </section>
      ...
      <section id="licencia" style={styles.sectionPadding}>
        <div style={styles.asymmetricGrid}>
          <div style={styles.pricingTextSide}>
            ...
            <h2 style={styles.pricingSideTitle}>No es un gasto. <br />Es tu nueva <span style={{color: '#0066ff'}}>Directora de Operaciones.</span></h2>
      ...
      {/* --- SECCIÓN PRECIOS --- */}
      <section id="precio" style={styles.sectionPadding}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          <small style={styles.underTheHood}>PLANES DE SOBERANÍA</small>
          <h2 style={styles.secTitle}>La inversión más inteligente <br/> para tu centro.</h2>
        </div>

        <div style={styles.pricingGrid}>
          {/* PLAN SOLO */}
          <div style={styles.priceCard}>
            <h3 style={styles.planName}>Solo Edition</h3>
            <div style={styles.priceValue}>100€<small style={styles.priceMonth}>/mes</small></div>
            <p style={styles.planDesc}>Perfecto para fisioterapeutas independientes.</p>
            <div style={styles.virtueListMini}>
              <Virtue text="1 Especialista" />
              <Virtue text="IA Ana 2.5 Flash 24/7" />
              <Virtue text="Historial Clínico por Voz" />
            </div>
            <button onClick={() => window.location.href='/setup?plan=solo'} style={styles.btnActivateSec}>EMPEZAR GRATIS</button>
          </div>
          ...
          <motion.div 
            ...
            style={styles.priceCardFeatured}
          >
            <div style={styles.featuredBadge}>MÁS RENTABLE</div>
            <h3 style={styles.planName}>Team Edition</h3>
            <div style={styles.priceValue}>300€<small style={styles.priceMonth}>/mes</small></div>
            <p style={styles.planDesc}>Para clínicas con hasta 5 especialistas.</p>
            <div style={styles.virtueListMini}>
              <Virtue text="Hasta 5 Especialistas" />
              <Virtue text="Multi-Servicio (Fisio, Podo...)" />
              <Virtue text="Balance de Ganancias Avanzado" />
              <Virtue text="Soporte Prioritario" />
            </div>
            <button onClick={() => window.location.href='/setup?plan=team'} style={styles.btnActivate}>ACTIVAR TEAM PRO ➜</button>
          </motion.div>

          {/* PLAN CLINIC */}
          <div style={styles.priceCard}>
            <h3 style={styles.planName}>Clinic Edition</h3>
            <div style={styles.priceValue}>500€<small style={styles.priceMonth}>/mes</small></div>
            <p style={styles.planDesc}>Para grandes policlínicas y centros médicos.</p>
            <div style={styles.virtueListMini}>
              <Virtue text="Especialistas Ilimitados" />
              <Virtue text="Multi-Sede Global" />
              <Virtue text="Consultoría Estratégica Ana" />
              <Virtue text="Seguridad Enterprise" />
            </div>
            <button onClick={() => window.location.href='/setup?plan=clinic'} style={styles.btnActivateSec}>CONTACTAR VENTAS</button>
          </div>
        </div>
      </section>
      ...
      <section style={styles.sectionPadding}>
        <div style={styles.faqAsymmetricGrid}>
          <div style={styles.faqTextSide}>
             ...
             <FaqBlock q="¿Cómo funcionan las Banderas Rojas?" a="Ana realiza un triaje clínico inteligente. Casos de tráfico o bebés bloquean la cita automática y derivan a tu teléfono." />
      ...
      <section style={{...styles.sectionPadding, background:'rgba(255,255,255,0.01)'}}>
        <div style={styles.faqAsymmetricGrid}>
          ...
          <div style={styles.faqTextSide}>
             ...
             <FaqBlock q="¿Puedo importar mis pacientes?" a="Motor CSV incluido. Ana reconocerá a tus pacientes habituales por su nombre desde el primer saludo." />
      ...
      <footer style={styles.footer}>
        <div style={styles.footerGrid}>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '14px', opacity: 0.3, marginTop: '20px', lineHeight: '1.8', maxWidth: '300px' }}>
              La primera plataforma de gestión médica con IA Conductual y Accesibilidad de Grado Superior.
            </p>
          </div>
          ...
          <div style={styles.footerLinksGroup}>
             ...
             <Link href="/garantia" style={styles.fLink}>Garantía de Élite</Link>
             <Link href="/devolucion" style={styles.fLink}>Política de Devolución</Link>
          ...
          <div style={styles.footerLinksGroup}>
             ...
             <Link href="/aviso-legal" style={styles.fLink}>Aviso Legal</Link>
             <Link href="/condiciones" style={styles.fLink}>Condiciones de Uso</Link>
             <Link href="/terminos" style={styles.fLink}>Términos de Servicio</Link>
             <Link href="/privacidad" style={styles.fLink}>Privacidad Pro</Link>
             <Link href="/rgpd" style={styles.fLink}>Contrato RGPD</Link>
          ...
          <div style={styles.footerLinksGroup}>
             ...
             <p style={{ ...styles.fLink, color: '#25D366', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '8px' }}>
                <MessageCircle size={16} /> +34 615 200 612
             </p>
             <p style={{ fontSize: '11px', opacity: 0.3, marginTop: '10px' }}>Granada, España | USA LLC Ready</p>
          </div>
        </div>

        {/* LÍNEA DE COPYRIGHT */}
        <div style={{ textAlign: 'center', marginTop: '80px', paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
