  ...
  return (
    <section style={styles.heroSection} aria-label="Introducción Principal">
      ...
      >
        ...
        {/* TEXTO DESCRIPTIVO SEO-FRIENDLY */}
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  primaryBtn: { background: '#0066ff', color: '#fff', border: 'none', padding: '20px 40px', borderRadius: '16px', fontSize: '16px', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 20px 40px -10px rgba(0,102,255,0.4)', transition: '0.3s' },
  secondaryBtn: { background: 'rgba(255,255,255,0.05)', color: '#fff', border: '1px solid rgba(255,255,255,0.1)', padding: '20px 40px', borderRadius: '16px', fontSize: '16px', fontWeight: 800, cursor: 'pointer' },
