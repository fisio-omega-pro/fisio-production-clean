...
import { BalanceFinanciero } from './types';      // Un solo punto (.)
import { GlassCard } from './Atoms';              // Asumiendo que Atoms.tsx está al lado
import { THEME } from './theme';                  // Un solo punto (.)
