    ...
    <div style={containerStyle}>
      ...
      <motion.div layout style={cardStyle}>
        <AnimatePresence mode="wait">
         ...
         {/* STEP 4: SUSCRIPCIÓN PROFESIONAL */}
          {step === 4 && (
            <motion.div key="s4" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }}>
              ...
              {/* BLOQUE DE CONSENTIMIENTO LEGAL (Nicho Salud) */}
      <div style={{ marginTop: '20px', padding: '15px', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)', textAlign: 'left' }}>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
          <input
            type="checkbox"
            id="legalCheck"
            style={{ width: '18px', height: '18px', marginTop: '2px', cursor: 'pointer' }}
            onChange={(e) => setFormData({...formData, aceptacion_legal: e.target.checked})}
          />
          <label htmlFor="legalCheck" style={{ fontSize: '11px', color: 'rgba(255,255,255,0.5)', lineHeight: '1.4' }}>
            He leído y acepto los <a href="/terminos" target="_blank" style={{color:'#0066ff', fontWeight:700, textDecoration:'none'}}>Términos de Servicio</a> y el <a href="/rgpd" target="_blank" style={{color:'#0066ff', fontWeight:700, textDecoration:'none'}}>Contrato de Datos de Salud</a> (RGPD v1.1).
          </label>
        </div>
      </div>
...
const benefitList: React.CSSProperties = { display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '20px', textAlign: 'left' };
