            ...
            <motion.div key="s4" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
              <div style={pricingCard}>
                ...
                <div style={benefitList}>
                  ...
                  <div style={benefitItem}><CheckCircle2 size={16} color="#10b981" /> <strong>Antigoteo:</strong> Cero No-Shows con fianza</div>
                  <div style={benefitItem}><CheckCircle2 size={16} color="#10b981" /> <strong>Voz:</strong> Historial Clínico manos libres</div>
                  <div style={benefitItem}><CheckCircle2 size={16} color="#10b981" /> <strong>Accesibilidad:</strong> Modo Invidente Nativo</div>
                </div>
              </div>
