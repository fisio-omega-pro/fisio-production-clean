        ...
        <AnimatePresence mode="wait">
          ...
          {step === 3 && (
            <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <div style={timeGrid}>
                <div style={inputGroup}><label style={labelStyle}>Precio Sesión (€)</label><div style={inputWrapper}><Euro size={14} style={inputIcon}/><input type="number" style={inputFieldShortPad} value={formData.precio} onChange={e => setPrecio(parseInt(e.target.value))} /></div></div>
                <div style={inputGroup}><label style={labelStyle}>Fianza (€)</label><div style={inputWrapper}><ShieldCheck size={14} style={inputIcon}/><input type="number" style={inputFieldShortPad} value={formData.fianza} onChange={e => setFianza(parseInt(e.target.value))} /></div></div>
              </div>
          ...
          {step === 4 && (
            <motion.div key="s4" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
              ...
              <button onClick={() => window.location.href='/dashboard'} style={btnPay}>
