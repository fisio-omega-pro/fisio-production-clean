...
// --- REGISTRO DE CLÍNICA: ALTA, CIFRADO Y FACTURACIÓN (VERSION FINAL NASA) ---
app.post('/api/register', async (req, res) => {
  ...
  try {
    ...
    const slots = d.hace_descanso === true ? [{start: d.descanso_inicio, end: d.descanso_fin}] : [];
    ...
    res.status(500).json({ error: "Fallo en el alta. Reintente." }); 
  }
});
    // 2. ==========================================
