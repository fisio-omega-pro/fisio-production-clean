...
const FAQS: FaqItem[] = [
  ...
  { type: 'security', q: "¿Qué sucede con la confidencialidad de los historiales médicos?", a: "Cada expediente está blindado mediante cifrado AES-256 en reposo (Google Cloud/Firestore) y TLS en tránsito. Fisiotool cumple con los estándares DPA de salud de la UE, asegurando que los datos sensibles permanezcan bajo su exclusiva jurisdicción y responsabilidad técnica." },
