...
export const FinanzasView: React.FC<FinanzasViewProps> = ({ balance }) => {
  return (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px' }}>
        ...
        <GlassCard hoverEffect style={{ borderBottom: `4px solid ${THEME.colors.success}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
            <div style={{ color: THEME.colors.success, background: 'rgba(16,185,129,0.1)', padding: '8px', borderRadius: '8px' }}>
              <PieChart size={20} />
            </div>
            <span style={{ fontSize: '11px', fontWeight: 800, color: THEME.colors.success }}>
              +{balance.tendenciaMensual}%
            </span>
          </div>
        ...
        <GlassCard hoverEffect style={{ borderBottom: `4px solid ${THEME.colors.warning}` }}>
          <div style={{ marginBottom: '20px' }}>
            <div style={{ width: 'fit-content', color: THEME.colors.warning, background: 'rgba(245,158,11,0.1)', padding: '8px', borderRadius: '8px' }}>
              <TrendingUp size={20} />
            </div>
          </div>
        ...
        <GlassCard hoverEffect style={{ borderBottom: `4px solid ${THEME.colors.primary}` }}>
          <div style={{ marginBottom: '20px' }}>
            <div style={{ width: 'fit-content', color: THEME.colors.primary, background: 'rgba(0,102,255,0.1)', padding: '8px', borderRadius: '8px' }}>
              <Sparkles size={20} />
            </div>
          </div>
